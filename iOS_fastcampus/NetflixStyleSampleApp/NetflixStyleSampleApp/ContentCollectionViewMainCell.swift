...
class ContentCollectionViewMainCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        [imageView, descriptionLabel, contentStackView].forEach {
            // StackView에 UI를 넣을 때는 addArrangeSubview() 메소드를 사용해아 원하는 결과를 얻을 수 있음
        ...
        infoButton.setImage(UIImage(systemName: "inf.circle"), for: .normal)
